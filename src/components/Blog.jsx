...
const Blog = () => {
  ...
  return (
    <section ref={ref} className="relative py-32 px-4 overflow-hidden bg-dark">
      ...
      <motion.div
        className="absolute top-20 right-10 w-40 h-40 bg-magenta rounded-full opacity-10 blur-3xl"
        animate={{
          y: [0, -20, 0],
          scale: [1, 1.2, 1]
        }}
      ...
      />
      <motion.div
        className="absolute bottom-20 left-10 w-60 h-60 bg-cyan rounded-full opacity-10 blur-3xl"
        animate={{
          y: [0, 20, 0],
          scale: [1, 1.3, 1]
        }}
