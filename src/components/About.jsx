...
const About = () => {
  ...
  return (
    <section ref={ref} className="relative pt-32 pb-8 px-4 overflow-hidden">
      {/* Background gradient */}
            ...
            >
              ...
              >
                <ChevronRight className="w-6 h-6" />
                  ...
                  {/* Image Info - Mobile: Üstte, Desktop: Altta */}
                  <div className="md:hidden absolute top-4 left-4 right-4 z-20">
                    <h3 className="font-poppins font-bold text-xl text-white mb-2">
                      {selectedImage.title}
                    </h3>
                    <span className="inline-block px-3 py-1 text-xs font-semibold text-white bg-primary/80 backdrop-blur-sm rounded-full">
              ...
              {/* Image Info - Desktop: Altta */}
              <div className="hidden md:block absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent rounded-b-2xl">
              ...
              {/* Image Counter */}
              <div className="absolute top-4 right-4 px-4 py-2 rounded-full bg-black/50 backdrop-blur-sm text-white text-sm font-inter">
